...
It renames all the occurrences of bdx_walking (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the bdx_walking folder
        os.rename(
            os.path.join(root_dir_path, "exts", "bdx_walking", "bdx_walking"),
            os.path.join(root_dir_path, "exts", "bdx_walking", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "bdx_walking"), os.path.join(root_dir_path, "exts", new_name))
